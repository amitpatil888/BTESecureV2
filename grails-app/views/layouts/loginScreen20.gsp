...
<div id="login">
    <div class="inner">
        ...
        <form action="${postUrl ?: '/login/authenticate'}" method="POST" id="loginForm" class="form" autocomplete="off">
            ...
            <ul>
                <li>
                    <label for="username" class="fa fa-user"><g:message code='springSecurity.login.username.label'/>:</label>
                    <input type="text" class="text_" name="${usernameParameter ?: 'username'}" id="username"/>
                </li>

                <li>
                    <label for="password" class="fa fa-lock"><g:message code='springSecurity.login.password.label'/>:</label>
