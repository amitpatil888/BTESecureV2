...
<div class="form">
    ...
    <div class="login">
        <form action="">
            ...
            <ul>
                <li>
                    <span class="un"><i class="fa fa-user"></i></span><input type="text" required class="text" id="username"/></li>
                <li>
                    <span class="un"><i class="fa fa-lock"></i></span><input type="password" required class="text" id="password"/></li>
                <li>
